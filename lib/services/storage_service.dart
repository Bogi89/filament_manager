...
class StorageService {
  ...
  static Future<void> saveFilaments(
  ...
  /// Löscht ausschließlich die lokal gespeicherten
  /// Filament- und Druckauftragsdaten.
  ///
  /// Diese Methode wird verwendet, nachdem Gastdaten
  /// erfolgreich in ein Firebase-Benutzerkonto übernommen
  /// wurden.
  ///
  /// Einstellungen und andere SharedPreferences-Werte
  /// bleiben vollständig erhalten.
  static Future<void> clearLocalData() async {
    final prefs =
        await SharedPreferences.getInstance();

    await prefs.remove(filamentsKey);

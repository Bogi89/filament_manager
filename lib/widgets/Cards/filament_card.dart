...
class _FilamentCardState extends State<FilamentCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalWeight = f.totalWeight;

    final remainingWeight = f.spools.fold<double>(
      0,
      (sum, spool) => sum + spool.weight,
    );

    final percent = (remainingWeight / totalWeight) * 100;
          ...
          child: InkWell(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => FilamentDetailPage(filament: f),
                ),
              );
            },
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (newWeight != null) {
                                    ...
                                    f.remainingWeight = f.spools.fold(
                                      0.0,
                                      (sum, spool) => sum + spool.weight,
                                    );

                                    context.read<AppState>().updateFilament(f);
                                  }
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                final currentWeight = f.spools.fold<double>(
                                  0,
                                  (sum, spool) => sum + spool.weight,
                                );
